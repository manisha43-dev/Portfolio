        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 ">
            ...
            <p className="text-muted-foreground">
              I specialize in creating responsive,accessible, and performate web
              applications usiing modern technologies.
            </p>
              ...
              <div className="flex items-start gap-4">
                    ...
                    <Briefcase className="h-6 w-6 text-primary"/>
                       ...
                       <div className="text-left">
                        ...
                        <p className="text-muted-foreground">Leadinng projects from conception to completion with agile methodologies</p>
                    </div>
                </div>
            </div>
